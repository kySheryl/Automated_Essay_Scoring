...
apigClientFactory.newClient = function (config) {
    ...
    var invokeUrl = 'https://298hv4l96j.execute-api.us-east-1.amazonaws.com/v2';
    ...
    apigClient.logInPost = function (params, body, additionalParams) {
        ...
        var logInPostRequest = {
            ...
            path: pathComponent + uritemplate('/log-in').expand(apiGateway.core.utils.parseParametersToObject(params, [])),
